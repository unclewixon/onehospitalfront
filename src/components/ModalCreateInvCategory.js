...
class ModalCreateInvCategory extends Component {
	componentDidMount() {
				...
				<div className="modal-dialog modal-sm modal-centered" role="document">
					<div className="modal-content text-center">
						...
						<div className="onboarding-content with-gradient">
							<h4 className="onboarding-title">Create Inventory Category</h4>
...
export default connect(null, { closeModals })(ModalCreateInvCategory);
