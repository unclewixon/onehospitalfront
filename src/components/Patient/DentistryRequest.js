						...
						<form onSubmit={handleSubmit(onSubmit)}>
							<div className="row">
								...
								<div className="form-group col-sm-6">
									...
									<Select
										name="service_to_request"
										placeholder="Select service to request from"
										isMulti
										options={labCategories}
										ref={register({ name: 'service_to request' })}
										onChange={evt => {
											setValue('service_to request', String(evt.value));
										}}
										required
									/>
								</div>
...
export default DentistryRequest;
