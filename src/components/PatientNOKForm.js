...
import { API_URI, ethnicities, gender, maritalStatus, insuranceStatus } from '../services/constants';
            ...
            <div className="onboarding-content with-gradient">
                <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="row">
                            <div className="col-sm">
                                <div className="form-group">
                                    ...
                                    />
                                    <small className="text-danger">
                                        {errors.nok_date_of_birth && errors.nok_date_of_birth.message}
                                    </small>
                                </div>
                            </div>
                            <div className="col-sm">
                    ...
                    <div className="modal-footer ">
                        ...
                        <button
                            className="btn btn-primary buttons-on-right"
                            type="submit"
                        >
...
export default connect(mapStateToProps, { prevStep, closeModals })(PatientNOKForm);
