...
const HeadCircumference = ({ newVital }) => {
		...
		try {
			...
			newVital
				...
				.forEach(function(item, index) {
					...
					let res = { name: StartDate, item: item.reading.circumference };
					data.push(res);
				});
			setData(data);
	...
	const info = {
		...
		inputs: [
			{ name: 'circumference', title: 'Head Circumference', weight: 'cm' },
		],
	};
		...
		<div className="row vital">
			...
			<div className="col-4">
				<div className="text-center">
					<div className="last-reading">Last Head Circumference Reading:</div>
