			...
			<div className="element-box m-0 mb-4 p-3">
				<form className="row">
					...
					<div
						...
						ref={refChecked}
						style={{ marginTop: '2.2rem', fontSize: '1.2rem', display: 'none' }}
					>
						<div
							className="d-flex"
							// style={{ display: "none" }}
						>
							<a className="user-action" href="#">
								<div className="os-icon os-icon-email-forward"></div>
							</a>
							<a className="user-action mx-3" href="#">
								<div className="os-icon os-icon-email-forward"></div>
							</a>
						</div>
					</div>
