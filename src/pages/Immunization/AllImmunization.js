			...
			<div className="row">
				<div className="col-sm-12">
					<div className="element-wrapper">
						...
						<h6 className="element-header">All Immunization Enrolment</h6>
							...
							<table className="table table-striped">
								<thead>
									<tr>
										...
										<th className="text-center">Date of Enrolment</th>
...
export default connect(mapStateToProps, { loadImmunization })(AllImmunization);
